package ru.t1.java.demo.configurations;
...
//        props.put("socket.connection.setup.timeout.max.ms", socketConnectionSetupTimeoutMaxMs);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, T> kafkaListenerContainerFactoryDto(
